...
username = "ty.cs.student2025@gmail.com"  # Enter your username in the quotes
password = "$h@keeb_2025"  # Enter your password in the quotes
        ...
        if text:
            ...
            if not prev_answer or overwrite_previous_answers:
                if "experience" in label or "years" in label:
                    ...
                    answer = "https://github.com/ShakeebSk/AutoHire-Intelligent-Job-Application-System"
...
def main() -> None:
    try:
        ...
        msg = f"\n{quote}\n\n\nBest regards,\nShakeeb Shaikh\nhttps://www.linkedin.com/in/shakeeb-shaikh-02b32b282/=/\n\n"
